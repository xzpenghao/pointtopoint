...
public class DirectYYDJ {
	...
	public DirectYYDJ(String bdcdyh, String zl, String yysx, String bdcdjzmh, String djjg, String djsj, String qszt, String ywh, String zxsj, String qxdm) {
		this.bdcdyh = bdcdyh;
		this.zl = zl;
		this.yysx = yysx;
