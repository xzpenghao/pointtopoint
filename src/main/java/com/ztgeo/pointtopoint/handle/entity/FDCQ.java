...
public class FDCQ {
    ...
    private String tdqlxz;//土地使用权力性质 新增
    private String tdsyqr;//土地使用权人 新增
    private String dytdmj;//独用土地面积 新增
    private String fttdmj;//分摊土地面积 新增
    ...
    public FDCQ(String id, String cxrid, String bdcdyh, String fdzl, String jzmj, String ghyt, String fwxz, String jgsj, String tdsyqssj, String tdsyjssj, String bdcqzh, String djjg, String zyjzmj, String ftjzmj, String djsj, String gyfs, String fdcjyjg, String fwjg, String fwlx, String gyr, String gyqk, String qszt, String ywh, String qlrdh, String qxdm, String qllx, String sfdy, String sfcf, String tdqlxz, String tdsyqr, String dytdmj, String fttdmj) {
        this.id = id;
        this.cxrid = cxrid;
        this.bdcdyh = bdcdyh;
        this.fdzl = fdzl;
